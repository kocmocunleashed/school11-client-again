...
export function HomeContent() {
  ...
  return <main id="main-content">
    <section className="arrival">
      <div className="arrival-grid shell mx-auto w-[var(--shell)]">
    ...
    <HallOfFame home />
    <section className="section shell mx-auto w-[var(--shell)] home-news" id="news"><div className="section-heading"><div><h2>Манай сургуулийн хэмнэл.</h2></div><Link href="/news" className="text-action">Бүх мэдээ <ArrowUpRight /></Link></div><NewsBrowser items={news} home /></section>
    <section className="join-section shell mx-auto w-[var(--shell)]"><div><h2>{copy.join_title}</h2><Link className="primary-button" href="/apply">Элсэлттэй танилцах <ArrowRight /></Link></div><span className="join-mark" aria-hidden="true"><ArrowUpRight /></span></section>
  </main>;
}
