...
export const fallbackTeachers: Teacher[] = [
  ["Д. Наранцэцэг", "Захирал", 18],
  ["Б. Энхбаяр", "Сургалтын менежер", 12],
  ["О. Мөнхзул", "Нийгмийн ажилтан", 9],
  ["Г. Батбаяр", "Захиргаа, аж ахуйн менежер", 15],
  ...
  bio_mn: ["Сургуулийн хөгжлийн бодлого, удирдлага, хамтын ажиллагааг хариуцна.", "Сургалтын төлөвлөлт, хөтөлбөрийн хэрэгжилт, багш нарын арга зүйн ажлыг зохион байгуулна.", "Сурагчдын хөгжил, хамгаалал болон эцэг эхтэй хамтран ажиллах үйл ажиллагааг дэмжинэ.", "Сургуулийн өдөр тутмын үйл ажиллагаа, орчин, тоног төхөөрөмжийн хэвийн ажиллагааг хариуцна."][index],
  bio_en: null,
  photo_url: null,
  is_featured: true,
