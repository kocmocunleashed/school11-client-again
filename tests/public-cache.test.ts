...
describe("public cache invalidation", () => {
  test("all public CMS resources immediately expire the shared data cache", () => {
    for (const resource of ["news", "teachers", "years", "achievements", "sections", "courseItems", "settings", "hallOfFame", "events", "landingTimeline"]) {
    ...
    expect(expire).toHaveBeenCalledTimes(10);
